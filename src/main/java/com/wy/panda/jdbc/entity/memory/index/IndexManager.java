...
import com.wy.panda.util.Tuple;
...
public class IndexManager<K, V> {
	...
	public void parseIndexes() throws Exception {
		...
		com.wy.panda.jdbc.annotation.Index[] indexArray = indexes.value();
		this.indexNames = new String[indexArray.length];
		int i = 0;
		for (com.wy.panda.jdbc.annotation.Index index : indexArray) {
	...
	public Tuple<String, Index<K, V>> buildIndex(Class<V> clazz, com.wy.panda.jdbc.annotation.Index index) 
			throws Exception {
